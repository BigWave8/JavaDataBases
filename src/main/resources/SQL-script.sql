...
CREATE USER 'rostyk'@'%' IDENTIFIED BY 'password';
GRANT SELECT ON *.* TO 'rostyk'@'%';
...
INSERT INTO city (city, region_id) VALUES
	('Lviv', '6'),
	('Mykolaiv', '6'),
	('Yavoriv', '6'),
	('Sokilnyky', '6'),
...
INSERT INTO adress (street, house_number, apartment_number, `index`, city_id) VALUES
	('Shevchenka', '1', '1', '79000', '1'),
...
INSERT INTO name (name, surname, middle_name) VALUES
	('Dima', 'Veres', NULL),
	('Dima', 'Oryshchak', NULL),
...
INSERT INTO courier (name_id) VALUES
	('2'),
	('2'),
	('2'),
	('2'),
...
INSERT INTO operator (name_id) VALUES
	('5'),
	('7'),
	('7'),
	('7'),
...
INSERT INTO user (phone_number, adress_id, name_id) VALUES
	('380961234567', '4', '4'),
	('380961234568', '7', '3'),
	('380961234569', '8', '2'),
	('380961234560', '6', '1'),
...
INSERT INTO user_operator (user_id, operator_id) VALUES
	('1', '6'),
	('3', '1'),
	('5', '2'),
	('7', '3'),
...
INSERT INTO parcel_on_way (courier_id) VALUES
	('3'),
	('5'),
	('7'),
	('9'),
...
INSERT INTO parcel(order_number, category, mass_in_kilogram, fragility, date_of_receiving, sender, recepient, sender_id_department, recepient_id_department, parcel_on_way_route_number) VALUE
